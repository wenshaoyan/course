...
public class ClientVersion implements org.apache.thrift.TBase<ClientVersion, ClientVersion._Fields>, java.io.Serializable, Cloneable, Comparable<ClientVersion> {
  ...
  public ClientVersion setVersion_name(String version_name) {
    this.version_name = version_name;
    return this;
  }
  ...
  public ClientVersion setVersion_number(String version_number) {
    this.version_number = version_number;
    return this;
  }
  ...
  public ClientVersion setDownload_url(String download_url) {
    this.download_url = download_url;
    return this;
  }
