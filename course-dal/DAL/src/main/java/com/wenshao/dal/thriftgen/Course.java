...
public class Course implements org.apache.thrift.TBase<Course, Course._Fields>, java.io.Serializable, Cloneable, Comparable<Course> {
  ...
  private static final org.apache.thrift.protocol.TField COURSE_TYPE_ALL_FIELD_DESC = new org.apache.thrift.protocol.TField("courseTypeAll", org.apache.thrift.protocol.TType.STRUCT, (short)9);
  private static final org.apache.thrift.protocol.TField IMAGE_URL_FIELD_DESC = new org.apache.thrift.protocol.TField("image_url", org.apache.thrift.protocol.TType.STRING, (short)10);
  ...
  public CourseTypeAll courseTypeAll; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    COURSE_TYPE_ALL((short)9, "courseTypeAll"),
    IMAGE_URL((short)10, "image_url");
  ...
  static {
    ...
    tmpMap.put(_Fields.AUTHOR_ID, new org.apache.thrift.meta_data.FieldMetaData("author_id", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.COURSE_TYPE_ALL, new org.apache.thrift.meta_data.FieldMetaData("courseTypeAll", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, CourseTypeAll.class)));
    ...
    java.lang.String image_url)
  {
    ...
    this.courseTypeAll = courseTypeAll;
  ...
  public Course(Course other) {
    ...
    if (other.isSetCourseTypeAll()) {
      this.courseTypeAll = new CourseTypeAll(other.courseTypeAll);
    }
  ...
  public CourseTypeAll getCourseTypeAll() {
    return this.courseTypeAll;
  }

  public Course setCourseTypeAll(CourseTypeAll courseTypeAll) {
    this.courseTypeAll = courseTypeAll;
    return this;
  }

  public void unsetCourseTypeAll() {
    this.courseTypeAll = null;
  }

  /** Returns true if field courseTypeAll is set (has been assigned a value) and false otherwise */
  public boolean isSetCourseTypeAll() {
    return this.courseTypeAll != null;
  }

  public void setCourseTypeAllIsSet(boolean value) {
    if (!value) {
      this.courseTypeAll = null;
    }
  }
  ...
  public Course setImage_url(java.lang.String image_url) {
    this.image_url = image_url;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case COURSE_TYPE_ALL:
      if (value == null) {
        unsetCourseTypeAll();
      } else {
        setCourseTypeAll((CourseTypeAll)value);
      }
      break;
  ...
  public boolean equals(Course that) {
    ...
    boolean this_present_courseTypeAll = true && this.isSetCourseTypeAll();
    boolean that_present_courseTypeAll = true && that.isSetCourseTypeAll();
    if (this_present_courseTypeAll || that_present_courseTypeAll) {
      if (!(this_present_courseTypeAll && that_present_courseTypeAll))
        return false;
      if (!this.courseTypeAll.equals(that.courseTypeAll))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetCourseTypeAll()) ? 131071 : 524287);
    if (isSetCourseTypeAll())
      hashCode = hashCode * 8191 + courseTypeAll.hashCode();
  ...
  public int compareTo(Course other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCourseTypeAll()).compareTo(other.isSetCourseTypeAll());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCourseTypeAll()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.courseTypeAll, other.courseTypeAll);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("courseTypeAll:");
    if (this.courseTypeAll == null) {
      sb.append("null");
    } else {
      sb.append(this.courseTypeAll);
    }
    first = false;
    if (!first) sb.append(", ");
    sb.append("image_url:");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (courseTypeAll != null) {
      courseTypeAll.validate();
    }
  }
  ...
  private static class CourseStandardScheme extends org.apache.thrift.scheme.StandardScheme<Course> {
        ...
        switch (schemeField.id) {
          ...
          case 9: // COURSE_TYPE_ALL
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.courseTypeAll = new CourseTypeAll();
              struct.courseTypeAll.read(iprot);
              struct.setCourseTypeAllIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Course struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      if (struct.courseTypeAll != null) {
        oprot.writeFieldBegin(COURSE_TYPE_ALL_FIELD_DESC);
        struct.courseTypeAll.write(oprot);
        oprot.writeFieldEnd();
      }
