...
public class Course implements org.apache.thrift.TBase<Course, Course._Fields>, java.io.Serializable, Cloneable, Comparable<Course> {
  ...
  public Course setDescribe(String describe) {
    this.describe = describe;
    return this;
  }
  ...
  public Course setImage_url(String image_url) {
    this.image_url = image_url;
    return this;
  }
  ...
  public int compareTo(Course other) {
    ...
    lastComparison = Boolean.valueOf(isSetAuthor_id()).compareTo(other.isSetAuthor_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAuthor_id()) {
    ...
    lastComparison = Boolean.valueOf(isSetCourseTypeAll()).compareTo(other.isSetCourseTypeAll());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCourseTypeAll()) {
