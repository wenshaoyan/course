...
public class TopicOption implements org.apache.thrift.TBase<TopicOption, TopicOption._Fields>, java.io.Serializable, Cloneable, Comparable<TopicOption> {
  ...
  public String to_context; // required
  public int to_topic_id; // required
  public String to_create_time; // required
  public String to_update_time; // required
  ...
  public TopicOption(
    ...
    String to_context,
    int to_topic_id,
    String to_create_time,
    String to_update_time)
  {
    this();
    this.to_id = to_id;
    setTo_idIsSet(true);
  ...
  public String getTo_context() {
    return this.to_context;
  }

  public TopicOption setTo_context(String to_context) {
    this.to_context = to_context;
    return this;
  }
  ...
  public TopicOption setTo_create_time(String to_create_time) {
    this.to_create_time = to_create_time;
    return this;
  }
  ...
  public String getTo_update_time() {
    return this.to_update_time;
  }

  public TopicOption setTo_update_time(String to_update_time) {
    this.to_update_time = to_update_time;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case TO_CREATE_TIME:
      if (value == null) {
        ...
        setTo_create_time((String)value);
      }
      break;
    ...
    case TO_UPDATE_TIME:
      if (value == null) {
        ...
        setTo_update_time((String)value);
      }
      break;
  ...
  public int compareTo(TopicOption other) {
    ...
    lastComparison = Boolean.valueOf(isSetTo_context()).compareTo(other.isSetTo_context());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTo_context()) {
    ...
    lastComparison = Boolean.valueOf(isSetTo_topic_id()).compareTo(other.isSetTo_topic_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTo_topic_id()) {
    ...
    lastComparison = Boolean.valueOf(isSetTo_create_time()).compareTo(other.isSetTo_create_time());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTo_create_time()) {
    ...
    lastComparison = Boolean.valueOf(isSetTo_update_time()).compareTo(other.isSetTo_update_time());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTo_update_time()) {
